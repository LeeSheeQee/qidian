...
<script>
    import SearchTitle from '@/components/finish/SearchTitle'
    import AllPart from '@/components/finish/AllPart'
    import AllList from '@/components/finish/AllList'
    export default {
        name: 'FinishContent',
        data() {
          return {
